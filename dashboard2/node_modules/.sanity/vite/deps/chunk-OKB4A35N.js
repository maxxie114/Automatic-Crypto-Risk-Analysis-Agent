...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources7-TMHKV53B.js")
});
...
function DocumentActionsProvider(props) {
  ...
  if (!actionProps)
    return null;
  let t1;
  $[4] !== actionProps.id || $[5] !== actionProps.liveEditSchemaType ? (t1 = actionProps.liveEditSchemaType ? getPublishedId(actionProps.id) : getDraftId(actionProps.id), $[4] = actionProps.id, $[5] = actionProps.liveEditSchemaType, $[6] = t1) : t1 = $[6];
  const documentId = t1;
  let t2;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t2 = () => onCompleteRef.current?.(), $[7] = t2) : t2 = $[7];
  let t3;
  $[8] !== actionProps ? (t3 = {
    ...actionProps,
    onComplete: t2
  }, $[8] = actionProps, $[9] = t3) : t3 = $[9];
  const t4 = actions || EMPTY_ARRAY$B;
  let t5;
  $[10] !== children || $[11] !== documentId ? (t5 = (t62) => {
    const {
      states
    } = t62;
    return (0, import_jsx_runtime2.jsx)(ActionsGuardWrapper, { states, documentId, children });
  }, $[10] = children, $[11] = documentId, $[12] = t5) : t5 = $[12];
  let t6;
  return $[13] !== t3 || $[14] !== t4 || $[15] !== t5 ? (t6 = (0, import_jsx_runtime2.jsx)(GetHookCollectionState, { args: t3, hooks: t4, resetRef: onCompleteRef, children: t5 }), $[13] = t3, $[14] = t4, $[15] = t5, $[16] = t6) : t6 = $[16], t6;
}
...
function ActionsGuardWrapper(props) {
  ...
  let t0;
  $[0] !== isLinked || $[1] !== states || $[2] !== t2 ? (t0 = isLinked ? states.map((s2) => !s2.action || !SUPPORTED_LINKED_TO_CANVAS_ACTIONS.includes(s2.action) ? {
    ...s2,
    disabled: true,
    title: t2("action.disabled-by-canvas.tooltip")
  } : s2) : states, $[0] = isLinked, $[1] = states, $[2] = t2, $[3] = t0) : t0 = $[3];
  let t1;
  return $[4] !== children || $[5] !== t0 ? (t1 = (0, import_jsx_runtime2.jsx)(DocumentActionsStateContext.Provider, { value: t0, children }), $[4] = children, $[5] = t0, $[6] = t1) : t1 = $[6], t1;
}
...
var paneMap = {
  component: (0, import_react2.lazy)(() => import("./_chunks-es-3EJ3Z2QC.js")),
  ...
  list: (0, import_react2.lazy)(() => import("./index2-XG7MNKZX.js"))
};
...
var structureTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      icon,
      component: (0, import_react2.lazy)(() => import("./index3-C736LBRB.js")),
...
//# sourceMappingURL=chunk-OKB4A35N.js.map
